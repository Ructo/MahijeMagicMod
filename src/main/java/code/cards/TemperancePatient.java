...
public class TemperancePatient extends AbstractFlipCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for (AbstractCard c : p.hand.group) {
            if ((c.type == CardType.ATTACK || c.type == CardType.CURSE || c.type == AbstractCard.CardType.STATUS) && c != this) {
